...
LogScope es una herramienta de análisis de logs diseñada bajo la filosofía de que "La IA es una herramienta, no un autor". Fue creada como parte del Bootcamp Act3, separando estrictamente la lógica de validación de la interfaz gráfica.
